CREATE TABLE PARAMETERS  (
	...
	PRMS_VALUE  varchar(70)  NULL,
	PRMS_DEFAULT_VALUE  varchar(70) NOT NULL,
	PRMS_DESCRIPTION  varchar(100)  NULL,
	PRMS_CREATE_BY varchar(50) NULL,
	PRMS_MODIFY_BY varchar(50) NULL,
	PRMS_DELETED_BY varchar(50) NULL,
	PRMS_DELETED varchar(1) NULL,	
	PRMS_CREATE_DATE datetime NULL,
	PRMS_MODIFY_DATE datetime NULL,
	PRMS_DELETED_DATE datetime NULL,
	PRIMARY KEY (PRMS_ID),
	UNIQUE(PRMS_CODE)
);


INSERT INTO MENUITEM VALUES ('parameters','angal.menu.btn.parameters','angal.menu.parameters','x','P','file','org.isf.parameters.gui.ParametersBrowser','N',3);
INSERT INTO GROUPMENU (GM_UG_ID_A, GM_MNI_ID_A, GM_ACTIVE) VALUES ('admin','parameters','Y');

INSERT INTO MENUITEM VALUES ('parameters_update','angal.menu.parameters.update','angal.menu.parameters.update','x','U','parameters','none','N',7);
INSERT INTO GROUPMENU (GM_UG_ID_A, GM_MNI_ID_A, GM_ACTIVE) VALUES ('admin','parameters_update','Y');

INSERT INTO MENUITEM VALUES ('parameters_user','angal.menu.btn.parameters.user','angal.menu.parameters.user','x','S','file','org.isf.parameters.gui.ParametersBrowserUser','N',4);
INSERT INTO GROUPMENU (GM_UG_ID_A, GM_MNI_ID_A, GM_ACTIVE) VALUES ('admin','parameters_user','Y');

INSERT INTO MENUITEM VALUES ('parameters_user_update','angal.menu.parameters.update','angal.menu.parameters.update','x','U','parameters_user','none','N',5);
INSERT INTO GROUPMENU (GM_UG_ID_A, GM_MNI_ID_A, GM_ACTIVE) VALUES ('admin','parameters_user_update','Y');
...
('ALLOWFILTERBILLBYMEDICAL', '@true', '@true', '', 'admin', 'admin', '2017-11-17 11:39:36', '2018-04-24 16:32:26', NULL, NULL, NULL),
...
('AUTOMATICLOTDISCHARGE', '@true', '@false', '', 'admin', 'admin', '2017-11-17 11:40:31', '2018-05-08 16:44:13', NULL, NULL, NULL),
...
('SMSENABLED', '@false', '@false', '', 'admin', 'admin', '2017-11-17 11:53:04', '2017-12-02 08:50:45', NULL, NULL, NULL),
...
('LOGINFORMWITHCHOOSINGUSERNAME', '@true', '@false', '', 'admin', 'admin', '2017-11-17 11:54:08', '2018-04-23 10:03:31', NULL, NULL, NULL),
...
('GENERALDATA_PROPERTIES', 'generalData.properties', 'generalData.properties', 'local parameters', 'admin', NULL, '2017-11-21 00:00:00', NULL, NULL, NULL, NULL),
('ALLOWGARANTEPERSON', '@true', '@false', 'permettre de choisir une personne garante', NULL, 'admin', '2018-04-23 00:00:00', '2018-04-23 18:33:11', NULL, NULL, NULL),
('GARANTEBILLSREPORT', 'garantebillsreport', 'garantebillsreport', 'nom du ficher impression des factures pour un garant', NULL, NULL, '2018-04-28 00:00:00', NULL, NULL, NULL, NULL),
('ALLOWPRODUCTINBILLWIHTEMPTYSTOCK', '@true', '@false', 'Permettre qu on facture des produits avec un stock Ó zero', NULL, NULL, '2018-05-03 00:00:00', NULL, NULL, NULL, NULL);
