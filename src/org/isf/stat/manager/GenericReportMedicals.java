...
public class GenericReportMedicals {

	public GenericReportMedicals(String searchtext, String typologie, String jasperFileName, Double min_qty) {
		try{
			...
			parameters.put("typologie", typologie); // real param
			parameters.put("min_qty", min_qty); // real param
			parameters.put("searchtext", searchtext); // real param
