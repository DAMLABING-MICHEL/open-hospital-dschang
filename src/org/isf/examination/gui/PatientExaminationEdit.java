...
public class PatientExaminationEdit extends JDialog {
	...
	private JDateChooser getJDateChooserDate() {
		if (jDateChooserDate == null) {
			...
			//jDateChooserDate.setLocale(new Locale(Param.string("LANGUAGE")));
