...
public class ExamBrowsingManager {
	...
	public ArrayList<Exam> getExamsOrderedByDesc() {
		try {
			return ioOperations.getExamsOrderedByDesc();
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	 ...
	 * @return the  {@link Exam} that match the given code or null if none. 
	 */
	public Exam getExam(String code) {
		try {
			return ioOperations.getExamsByCode(code);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	...
	public boolean isKeyPresent(Exam exam) {
		try {
			return ioOperations.isKeyPresent(exam.getCode());
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return false;
		}
	...
	public boolean deleteExam(Exam exam) {
		try {
			return ioOperations.deleteExam(exam.getCode());
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return false;
		}
	 ...
	 * @return <code>true</code> if the {@link Exam} has been deleted, <code>false</code> otherwise
	 */
	public boolean deleteExam(String code) {
		try {
			return ioOperations.deleteExam(code);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return false;
		}
