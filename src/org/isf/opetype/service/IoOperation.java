...
public class IoOperation {
	...
	public ArrayList<OperationType> getOperationType() throws OHException {
		...
		String sqlString = "SELECT OCL_ID_A, OCL_DESC, OCL_ACCOUNT FROM OPERATIONTYPE ORDER BY OCL_DESC";
	...
	public boolean newOperationType(OperationType operationType) throws OHException {
		...
		try {
			String sqlString = "INSERT INTO OPERATIONTYPE (OCL_ID_A, OCL_DESC, OCL_ACCOUNT) VALUES (?, ?, ?)";
			List<Object> parameters = new ArrayList<Object>();
			parameters.add(operationType.getCode());
			parameters.add(operationType.getDescription());
			parameters.add(operationType.getAccount());
			//parameters.add(operationType.getExpenseAccount());
	...
	public boolean deleteOperationType(String operationTypeID) throws OHException {
		DbQueryLogger dbQuery = new DbQueryLogger();
		boolean result = false;
		String sqlString = "DELETE FROM OPERATIONTYPE WHERE OCL_ID_A = ?";
		List<Object> parameters = Collections.<Object>singletonList(operationTypeID);
