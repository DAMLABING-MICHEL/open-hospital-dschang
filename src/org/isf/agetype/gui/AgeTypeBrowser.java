	...
	class AgeTypeBrowserModel extends DefaultTableModel {
		...
		public Object getValueAt(int r, int c) {
			if (c == 0) {
				...
				//return pAgeType.get(r).getFrom()>=12?pAgeType.get(r).getFrom()/12:pAgeType.get(r).getFrom();
			} else if (c == 2) {
				return pAgeType.get(r).getTo();
				//return pAgeType.get(r).getTo()>=12?pAgeType.get(r).getTo()/12:pAgeType.get(r).getTo();
			} else if (c == 3) {
