...
public class PregnancyExamEdit extends JDialog {
	...
	/**
	 * @uml.property  name="examListeners"
	...
	/**
	 * @uml.property  name="selectedPregnancyExam"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private PregnancyExam selectedPregnancyExam = null;
	/**
	 * @uml.property  name="examtype"
	 * @uml.associationEnd  
	 */
	...
	/**
	 * @uml.property  name="nonlabexampanel"
	 * @uml.associationEnd  
	 */
	private JPanel exampanel = null;
	/**
	 * @uml.property  name="examDesc"
	 * @uml.associationEnd  
	 */
	...
	/**
	 * @uml.property  name="examDefault"
	 * @uml.associationEnd  
	 */
	private VoLimitedTextField examDefault = null;
	/**
	 * @uml.property  name="examValues"
	 * @uml.associationEnd  
	 */
	...
	private JPanel getExamTypePanel() {
		...
		String[] types = new String[] {
				...
				MessageBundle
						.getMessage("angal.pregnancyexam.pre&postnatal") };
