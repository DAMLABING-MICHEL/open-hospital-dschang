...
public class PregnancyExamBrowser extends JFrame implements PregnancyExamListener{
	...
	/**
	 * @uml.property  name="exam"
	 * @uml.associationEnd  
	 */
	private PregnancyExam exam = null;
	/**
	 * @uml.property  name="examtable"
	 * @uml.associationEnd  
	 */
	private JTable examtable = null;
	/**
	 * @uml.property  name="eColumwidth" multiplicity="(0 -1)" dimension="1"
	 */
	...
	class PregnancyExamBrowserModel extends DefaultTableModel{
		...
		public Object getValueAt(int r, int c) {
			if (c == -1) {
				...
				case -0:
					return MessageBundle.getMessage("angal.pregnancyexam.pre&postnatal");
				case 1:
