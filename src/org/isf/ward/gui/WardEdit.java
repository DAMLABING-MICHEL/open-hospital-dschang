...
public class WardEdit extends JDialog {
	...
	private static EventListenerList wardListeners = new EventListenerList();
	...
	public static void addWardListener(WardListener l) {
		wardListeners.add(WardListener.class, l);
	}
	
	public static void removeWardListener(WardListener listener) {
