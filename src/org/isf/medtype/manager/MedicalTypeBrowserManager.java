...
public class MedicalTypeBrowserManager {
	...
	public ArrayList<MedicalType> getMedicalType() {
	 ...
	 public MedicalType getMedicalTypeByCode(String code) {
			try {
				return ioOperations.getMedicalTypeByCode(code);
			} catch (OHException e) {
				JOptionPane.showMessageDialog(null, e.getMessage());
				return null;
			}
	...
	public boolean deleteMedicalType(String medicalTypeID) {
		try {
			return ioOperations.deleteMedicalType(medicalTypeID);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return false;
		}
