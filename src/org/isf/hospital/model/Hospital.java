...
public class Hospital {
    ...
    private Integer population_area;
    /**
     * @param aCode
     * @param aDescription
     * @param aAddress
    ...
    public Hospital(String aCode, String aDescription, String aAddress, String aCity, String aTelephone, String aFax, String aEmail, Integer aLock,Integer apopulation_area) {
        super();
        this.code = aCode;
        ...
        this.email = aEmail;
        this.lock = aLock;
        this.population_area = apopulation_area;
    }
	...
	public Integer getPopulation_area() {
		return population_area;
	}
	public void setPopulation_area(Integer population_area) {
