...
public class SupplierEdit extends JDialog {
	...
	private static  EventListenerList supplierListeners = new EventListenerList();
	...
	public  static void addSupplierListener(SupplierListener l) {
		supplierListeners.add(SupplierListener.class, l);
	}
	
	public static void removeSupplierListener(SupplierListener listener) {
...
//	private String lastdescription;
	...
	private JPanel getDataPanel() {
		if (dataPanel == null) {
			...
			accountLabel= new JLabel(MessageBundle.getMessage("angal.supplier.account"));
			...
			dataPanel.add(accountLabel, null);
			dataPanel.add(getAccountTextField());
		...
		if (okButton == null) {
			...
			okButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					supplier.setSupAccount(accountTextField.getText().trim());
	...
	private JLabel getAccountLabel() {
		if (accountLabel == null) {
			accountLabel = new JLabel("Num\u00E9ro de compte:");
		}
		return accountLabel;
	}
	private JTextField getAccountTextField() {
		if (accountTextField == null) {
			...
			if (!insert) {
				accountTextField.setText(supplier.getSupAccount());
			}
