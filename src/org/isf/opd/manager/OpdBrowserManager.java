...
public class OpdBrowserManager {
	...
	public ArrayList<Opd> getOpd(String diseaseTypeCode,String diseaseCode, GregorianCalendar dateFrom,GregorianCalendar dateTo,int ageFrom, int ageTo,char sex,String newPatient, int start_index, int page_size) {
		try {
			return ioOperations.getOpdList(diseaseTypeCode,diseaseCode,dateFrom,dateTo,ageFrom,ageTo,sex,newPatient, start_index, page_size);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	}
	 public int getOpdListCount(String diseaseTypeCode,String diseaseCode, GregorianCalendar dateFrom,GregorianCalendar dateTo,int ageFrom, int ageTo,char sex,String newPatient) {
			try {
				return ioOperations.getOpdListCount(diseaseTypeCode,diseaseCode,dateFrom,dateTo,ageFrom,ageTo,sex,newPatient);
			} catch (OHException e) {
				JOptionPane.showMessageDialog(null, e.getMessage());
				return 0;
			}
	...
	public boolean deleteOpd(int opdID) {
		try {
			return ioOperations.deleteOpd(opdID);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return false;
		}
	...
	public HashMap<String, Integer> getCurativeOpd(int year){	
		try {
			return ioOperations.getCurativeOpd(year);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
	...
	public HashMap<String, Integer> getCountCPS(int year){	
		try {
			return ioOperations.getCountCPS(year);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		} catch (ParseException e) {
	...
	public HashMap<String, Integer> getCountDisease(int year,int diseaseId){	
		try {
			return ioOperations.getCountDisease(year,diseaseId);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		} catch (ParseException e) {
