...
//public class OpdEdit extends ModalJFrame  implements ActionListener {
			...
			okButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (insert){
						...
						opd.setProgMonth(manager.getProgMonth(date.get(GregorianCalendar.MONTH), date.get(GregorianCalendar.YEAR))+1);
