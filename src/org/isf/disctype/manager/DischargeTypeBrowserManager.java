...
public class DischargeTypeBrowserManager {
	...
	/**
	 * method that returns a Discharge Type by code
	 * @param code the code of the discharge type
	 * @return the Discharge type identified by by the given code
	 */
	public DischargeType getDischargeType(String code) {
		try {
			return ioOperations.getDischargeType(code);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
