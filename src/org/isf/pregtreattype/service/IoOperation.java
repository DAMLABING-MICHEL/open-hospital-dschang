...
public class IoOperation {
	...
	public boolean deletePregnantTreatmentType(String pregnantTreatmentTypeID) throws OHException {
		DbQueryLogger dbQuery = new DbQueryLogger();
		List<Object> parameters = Collections.<Object>singletonList(pregnantTreatmentTypeID);
		String sqlString = "DELETE FROM PREGNANTTREATMENTTYPE WHERE PTT_ID_A = ?";
		boolean result = false;
		try {
			result = dbQuery.setDataWithParams(sqlString, parameters, true);
