...
/*
	...
	*/
	...
	//private String[] pColums = { MessageBundle.getMessage("angal.menu.userm"), MessageBundle.getMessage("angal.menu.groupm"), MessageBundle.getMessage("angal.menu.descm") };  angal.menu.nameuser angal.menu.surname angal.menu.phones
	//added julio
	private String[] pColums = { MessageBundle.getMessage("angal.menu.userm"), MessageBundle.getMessage("angal.menu.groupm"), MessageBundle.getMessage("angal.menu.descm"), MessageBundle.getMessage("angal.menu.nameuser"), MessageBundle.getMessage("angal.menu.surname"), MessageBundle.getMessage("angal.menu.phones") };
	//
	//private int[] pColumwidth = {70, 70, 70, 150 };
	//private int[] pColumwidth = {70, 70, 150 };
	private int[] pColumwidth = {70, 70, 150,70,70,60 };
	private User user;
	...
	public UserBrowsing() {
		...
		pfrmWidth = screensize.width / 2 + 300;
		pfrmHeight = screensize.height / 2;
		setBounds((screensize.width -200) / 4, screensize.height / 4, pfrmWidth,
				pfrmHeight);
		
//		setBounds(pfrmWidth / 4, pfrmHeight / 4, pfrmWidth,
//				pfrmHeight);
	...
	class UserBrowserModel extends DefaultTableModel {
		...
		public Object getValueAt(int r, int c) {
			...
			//
				...
				return pUser.get(r).getName();
			}
			else if (c == 4) {
				return pUser.get(r).getSurname();
			}
			else if (c == 5) {
				return pUser.get(r).getPhone();
			}
			//
			return null;
		}
