...
public class MovWardBrowserManager {
	...
	public ArrayList<MovementWard> getMovementWard() {
		try {
			return ioOperations.getWardMovements(null, null, null, null);
		} catch (OHException e) {
	...
	public ArrayList<MedicalWard> getMedicalsWardWithPrice(String wardId) {
		try {
			return ioOperations.getMedicalsWard2(wardId);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	...
	/**
	 * Gets  the {@link MedicalWard} associated to the specified ward.
	 * If an error occurs a message error is shown and the <code>null</code> value is returned.
	 * @param wardId the ward id.
	 * @param medId the ward id.
	 * @return the retrieved medical.
	 */
	public MedicalWard getMedicalsWard(String wardId, int medId) {
		try {
	 ...
	 */
	public ArrayList<MovementWard> getMovementWard(String wardId, GregorianCalendar dateFrom, GregorianCalendar dateTo, MedicalType medicalTypeSelected) {
		try {
			return ioOperations.getWardMovements(wardId, dateFrom, dateTo, medicalTypeSelected);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	 ...
	 * @return all the retrieved movements.
	 */
	public ArrayList<MovementWard> getMovementWard(String wardId, GregorianCalendar dateFrom, GregorianCalendar dateTo, MedicalType medicalTypeSelected, int start_index, int page_size) {
		try {
			return ioOperations.getWardMovements(wardId, dateFrom, dateTo, medicalTypeSelected, start_index, page_size);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	...
	public MovementWard getMovementWardById(int getMovementWardById) throws OHException {	
		try {
			return ioOperations.getMovementWardById(getMovementWardById);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	...
	public boolean deleteMovementWard(int movementID) {
		try {
			return ioOperations.deleteMovementWard(movementID);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return false;
		}
	...
	public int getCurrentQuantity(String wardID, int medicalID) {
		try {
			return ioOperations.getCurrentQuantity(wardID, medicalID);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return 0;
		}
	...
	public int getRowCount(String wardId, GregorianCalendar dateFrom, GregorianCalendar dateTo, MedicalType medicalTypeSelected) {
		try {
			//return ioOperations.getWardMovements(wardId, dateFrom, dateTo, medicalTypeSelected);
			return ioOperations.getRowCount(wardId, dateFrom, dateTo, medicalTypeSelected);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return 0;
		}
	...
	public boolean updateMedicalsWard(ArrayList<MedicalWard> medSearch, Ward wardSelected) {
		
		try {
			return ioOperations.updateMedicalsWard(medSearch, wardSelected);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return false;
		}
