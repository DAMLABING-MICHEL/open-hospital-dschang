...
public class WardPharmacyRectify extends ModalJFrame {
				...
				jButtonOk.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if (reason.equals("")) {
							...
							message.append(MessageBundle.getMessage("angal.medicalstockward.rectify.reasonempty")); 
						...
						if (quantity == 0.){
							StringBuilder message = new StringBuilder();
							message.append(MessageBundle.getMessage("angal.medicalstock.physicalqtyequaltotheoricalqty")); 
							JOptionPane.showMessageDialog(WardPharmacyRectify.this, message.toString());
							return;	
						}
