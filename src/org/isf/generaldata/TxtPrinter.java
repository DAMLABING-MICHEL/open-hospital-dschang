...
public class TxtPrinter {
	...
	private final String FILE_PROPERTIES = Param.string("TXTPRINTER_PROPERTIES");
    ...
    public static int DEFAULT_CHARACTER_WIDTH=15;
    public static int DEFAULT_CHARACTER_HEIGHT=17;
    ...
    private TxtPrinter() {
    	try	{
			...
			CHARACTER_WIDTH = myGetProperty("CHARACTER_WIDTH", DEFAULT_CHARACTER_WIDTH);
			CHARACTER_HEIGHT = myGetProperty("CHARACTER_HEIGHT", DEFAULT_CHARACTER_HEIGHT);
