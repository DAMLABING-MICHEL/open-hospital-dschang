...
//public class PatientInsert extends JDialog
public class PatientInsert extends JDialog implements ActionListener{
	...
	private VoFloatTextField ageField = null;
...
//	private int oldAge;
	...
	private void initialize() {
		...
		this.setSize(new Dimension(722, 650));
							...
							if (jSecondNameTextField.getText().equals("")) {
								...
								if (age == -1) {
									...
									if(ValidationPatientGroup.GLOBAL.equals(validationGroup) ){
										...
										String city = jCityTextField.getText().trim();
	...
	private JTextField getAgeField() {
		if (ageField == null) {
			...
			ageField = new VoFloatTextField("",15);
			ageField.setText("0");
