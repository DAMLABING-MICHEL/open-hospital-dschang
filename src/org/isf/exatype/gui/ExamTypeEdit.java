...
//	private String lastexpenseaccount;
	...
	public ExamTypeEdit(JFrame owner,ExamType old,boolean inserting) {
		...
		lastaccount = examType.getAccount();
		///lastexpenseaccount = examType.getExpenseAccount();
		initialize();
	}
		...
		if (okButton == null) {
			...
			okButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					examType.setAccount(accountTextField.getText());
					//examType.setExpenseAccount(expenseAccountTextField.getText());
	...
	private JTextField getAccountTextField() {
		if (accountTextField == null) {
			...
			if (!insert) {
				accountTextField.setText(examType.getAccount());
				lastaccount = examType.getAccount();
			}
		}
...
//			if (!insert) {
//				expenseAccountTextField.setText(examType.getExpenseAccount());
//				lastexpenseaccount = examType.getExpenseAccount();
//			}
//		}
