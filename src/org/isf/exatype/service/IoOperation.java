...
public class IoOperation {
	...
	public boolean updateExamType(ExamType examType) throws OHException {
		...
		try {
			String query = "UPDATE EXAMTYPE SET EXC_DESC = ?, EXC_ACCOUNT = ?  WHERE EXC_ID_A = ?";
			ArrayList<Object> params = new ArrayList<Object>();
			params.add(examType.getDescription());
			params.add(examType.getAccount());
			//params.add(examType.getExpenseAccount());
	...
	public boolean newExamType(ExamType examType) throws OHException {
		...
		boolean result = false;
		try {
			String query = "INSERT INTO EXAMTYPE (EXC_ID_A, EXC_DESC, EXC_ACCOUNT) VALUES (?, ?, ?)";
			ArrayList<Object> params = new ArrayList<Object>();
			params.add(examType.getCode());
			params.add(examType.getDescription());
			params.add(examType.getAccount());
	 ...
	 * @throws OHException
	 */
	public boolean deleteExamType(String code) throws OHException {
